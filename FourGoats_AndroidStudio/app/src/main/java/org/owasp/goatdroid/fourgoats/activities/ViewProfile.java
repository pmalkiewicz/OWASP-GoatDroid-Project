...
public class ViewProfile extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getAction() != null && getIntent().getAction().equals(Intent.ACTION_VIEW)) {
            //activity was opened by implicit intent with an URI
            Uri uri = getIntent().getData();
            if (uri.getScheme().equals("fourgoats") && uri.getHost().equals("viewprofile")) {
            ...
            //activity was opened by explicit intent
        ...
        protected HashMap<String, String> doInBackground(Void... params) {
            ...
            try {
                if (sessionToken.equals("")) {
                    ...
                    profileInfo = rest.getProfile(sessionToken, username);
    ...
    private class RequestFriendAsyncTask extends
        ...
        protected HashMap<String, String> doInBackground(Void... params) {
            ...
            try {
                String sessionToken = uidh.getSessionToken();
                resultInfo = rest.doFriendRequest(sessionToken, username);
            } catch (Exception e) {
